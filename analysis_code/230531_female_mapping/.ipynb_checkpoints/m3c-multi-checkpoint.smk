...
rule separate_unmapped_reads:
    ...
    output:
        ...
        multi_bam=temp("bam/{cell_id}.hisat3n_dna.multi_align.bam"),
...
# split unmapped reads (cemba data)
...
#====================================================================
# continue mapping , align split reads
#====================================================================
...
rule sort_multi_bam:
    input:
        bam="bam/{cell_id}.hisat3n_dna.multi_align.bam"
    output:
